          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
                ...
                комфортную среду и развиваю HR-процессы.
                <br />
                Умею работать и с IT-специалистами, и с производственными
                командами. Знаю, как развивать клиентский сервис и создавать
                классное сообщество вокруг продукта, занимаюсь организацией
                мероприятий и конференций.
                <br /> Верю в силу нетворкинга и 6 рукопожатий.
              </p>
